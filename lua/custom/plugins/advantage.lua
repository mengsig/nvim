...
return {
  {
    ...
    cmd = 'Advantage',
    keys = {
      { '<leader>c', group = 'advantage' },
      { '<leader>cc', function() require('advantage').toggle() end, desc = 'advantage: toggle chat' },
      { '<leader>cs', function() require('advantage').add_selection() end, mode = 'x', desc = 'advantage: add selection' },
      { '<leader>cf', function() require('advantage').add_file() end, desc = 'advantage: add current file / netrw marks' },
      ...
      { '<leader>ce', function() require('advantage').pick_effort() end, desc = 'advantage: effort / thinking' },
